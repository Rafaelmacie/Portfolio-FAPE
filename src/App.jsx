...
const MODULOS_DATA = [
  {
    ...
    features: [
      ...
      { nome: "Cadastro e GED de Cooperados", status: "Operacional" },
      { nome: "Catálogo e Estoque (NCMs)", status: "Em Progresso" }
    ],
  ...
  },
  {
    ...
    features: [
      ...
      { nome: "Emissão de Fichas e Termos", status: "Planejado" }
    ],
    tech: "Mobile-First UI, AsyncStorage"
  },
  {
    id: 'cliente',
    ...
    features: [
      ...
      { nome: "Acompanhamento de Funil", status: "Planejado" }
    ],
    tech: "React, Clean Architecture"
  },
  {
    id: 'financeiro',
    ...
    features: [
      ...
      { nome: "Livro-Caixa e Auditoria", status: "Planejado" }
    ],
    tech: "Integração Bancária, PostgreSQL"
  },
  {
    id: 'executivo',
    ...
    features: [
      ...
      { nome: "Dashboards de Performance", status: "Planejado" }
    ],
    tech: "Data Visualization, Hexagonal Ports"
  }
];
            ...
            <div className="flex items-center gap-3">
              ...
              {!isSidebarCollapsed && (
                <div className="flex flex-col animate-in fade-in duration-300 overflow-hidden whitespace-nowrap">
                  ...
                  <p className="text-[9px] text-slate-900 uppercase tracking-widest font-bold mt-0.5">Itatira - CE</p>
                </div>
              )}
            </div>
          </div>
            ...
            <section id="home" className="min-h-[85vh] w-full flex flex-col xl:flex-row items-center justify-center py-16 px-8 md:px-16 lg:px-24 gap-12 lg:gap-16">
              ...
              <div className="flex-1 w-full flex flex-col items-start text-left">
                ...
                <p className="text-base md:text-lg text-slate-600 leading-relaxed w-full">
                  Explore a documentação viva do Sistema de Gerenciamento Administrativo para a Cooperativa Sertaneja - FAPE. Navegue pelos painéis para entender a estrutura de 
                  microsserviços, o design system modular e o progresso das funcionalidades desenvolvidas para a região de Itatira - CE.
                </p>
              </div>
